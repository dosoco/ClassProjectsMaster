...
kyle.fullName = kyle.firstName + " " + kyle.lastName;
...
kyle.address.push('1234 Nunya Ln');
kyle.address.push('Maryville, TN');
kyle.address.push('37804')
...
let obj = {
  countries : ['USA', 'Canada', 'China', 'South Korea', 'Philippines', 'Vietnam', 'Hungary', 'Greece', 'Germany'],
  houses: 1,
  isCool: false,
  language: 'English'
}
